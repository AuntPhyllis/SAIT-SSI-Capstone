...
export interface IFFIEntryPoint {
    ...
    vcx_pack_message: (commandId: number, walletHandle: number, message: number, messageLen: number, keys: string, sender: string, cb: any) => number;
    ...
    vcx_issuer_get_credential_msg: (commandId: number, credentialHandle: number, connectionHandle: number, cb: any) => number;
    vcx_issuer_send_credential_offer: (commandId: number, credentialHandle: number, connectionHandle: number, cb: any) => number;
    vcx_issuer_get_credential_offer_msg: (commandId: number, credentialHandle: number, connectionHandle: number, cb: any) => number;
    ...
    vcx_credential_get_request_msg: (commandId: number, handle: number, connectionHandle: number, payment: number, cb: any) => number;
    ...
    vcx_credentialdef_create_with_id: (commandId: number, sourceId: string, credentialDefId: string, issuerDid: string | null, revocationConfig: string | null, cb: any) => number;
