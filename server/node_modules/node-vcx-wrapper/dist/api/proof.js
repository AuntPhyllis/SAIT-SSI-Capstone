...
class Proof extends vcx_base_with_state_1.VCXBaseWithState {
    constructor(sourceId, { attrs, name }) {
        super(sourceId);
    ...
    static create(_a) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield proof._create((cb) => rustlib_1.rustAPI().vcx_proof_create(commandHandle, proof.sourceId, JSON.stringify(createDataRest.attrs), JSON.stringify([]), JSON.stringify(createDataRest.revocationInterval), createDataRest.name, cb));
                return proof;
            }
            catch (err) {
    ...
    static deserialize(proofData) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const proof = yield _super._deserialize.call(this, Proof, proofData, constructorParams);
                return proof;
            }
            catch (err) {
                throw new errors_1.VCXInternalError(err);
