...
class IssuerCredential extends vcx_base_with_state_1.VCXBaseWithState {
    ...
    static deserialize(credentialData) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const credential = yield _super._deserialize.call(this, IssuerCredential, credentialData, params);
                return credential;
            }
            catch (err) {
                throw new errors_1.VCXInternalError(err);
     ...
     *
     */
    getCredentialOfferMsg(connection) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield ffi_helpers_1.createFFICallbackPromise((resolve, reject, cb) => {
                    const rc = rustlib_1.rustAPI().vcx_issuer_get_credential_offer_msg(0, this.handle, connection.handle, cb);
                    if (rc) {
                        reject(rc);
                    }
     ...
     *
     */
    getCredentialMsg(connection) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield ffi_helpers_1.createFFICallbackPromise((resolve, reject, cb) => {
                    const rc = rustlib_1.rustAPI().vcx_issuer_get_credential_msg(0, this.handle, connection.handle, cb);
                    if (rc) {
                        reject(rc);
                    }
                }, (resolve, reject) => ffi.Callback('void', ['uint32', 'uint32', 'string'], (xHandle, err, message) => {
