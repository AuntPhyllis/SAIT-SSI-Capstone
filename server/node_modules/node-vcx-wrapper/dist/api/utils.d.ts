...
export declare function setActiveTxnAuthorAgreementMeta(text: string | null | undefined, version: string | null | undefined, hash: string | null | undefined, accMechType: string, timeOfAcceptance: number): number;
