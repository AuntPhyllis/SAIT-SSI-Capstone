...
function getLedgerAuthorAgreement() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            }, (resolve, reject) => ffi_1.Callback('void', ['uint32', 'uint32', 'string'], (xhandle, err, _agreement) => {
                if (err) {
                    reject(err);
                    return;
                }
...
function setActiveTxnAuthorAgreementMeta(text, version, hash, accMechType, timeOfAcceptance) {
    return rustlib_1.rustAPI().vcx_set_active_txn_author_agreement_meta(text, version, hash, accMechType, timeOfAcceptance);
}
