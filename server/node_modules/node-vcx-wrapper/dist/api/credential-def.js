...
class CredentialDef extends vcx_base_1.VCXBase {
     ...
     * ```
     */
    static create({ name, paymentHandle, revocationDetails, schemaId, sourceId }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                yield credentialDef._create((cb) => rustlib_1.rustAPI().vcx_credentialdef_create(commandHandle, sourceId, name, schemaId, issuerDid, 'tag1', JSON.stringify(revocation), paymentHandle, cb));
     ...
     * ```
     */
    static createWithId({ sourceId, credDefId, revocationConfig }) {
        return __awaiter(this, void 0, void 0, function* () {
            // Todo: need to add params for tag and config
            ...
            try {
                yield credentialDef._create((cb) => rustlib_1.rustAPI().vcx_credentialdef_create_with_id(commandHandle, sourceId, credDefId, issuerDid, revocation && JSON.stringify(revocation), cb));
                return credentialDef;
            }
            catch (err) {
                throw new errors_1.VCXInternalError(err);
